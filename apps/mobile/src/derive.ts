...
// Micropullback (2026-09-03) reuses consolidation_event's own kind
// vocabulary but needs distinct wording -- "act fast" is the whole point
// of this signal (a 1-candle pause resuming within seconds), and reusing
// the standard consolidation-breakout labels verbatim would read
// identically to the slower signal it's deliberately meant to be faster
// than. See ConsolidationStrategy's own doc comment in shared-types, and
