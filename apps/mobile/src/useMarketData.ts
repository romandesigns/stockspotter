...
export function useMarketData() {
  ...
  // Stamped client-side on each *successful* poll -- same reasoning as
  // the web app's own useMovers.ts lastUpdated: a failed poll (best-
  // effort, keeps showing stale data) shouldn't reset the clock, and
